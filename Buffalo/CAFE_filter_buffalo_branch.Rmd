...
# Save the families for 96 losses
Select_family[,c("FAMILY", "Freq")]%>%
  subset(FAMILY %in% c(Bbub_com_cafe_input_data[(Bbub_com_cafe_input_data$Bbub < Bbub_com_cafe_input_data$cattle_ave),]%>%extract2("FAMILY")))%>%
...
#### losses
```{r}
Bbub_com_cafe_input_data_losses <- Bbub_com_cafe_input_data[(Bbub_com_cafe_input_data$Bbub < Bbub_com_cafe_input_data$cattle_ave),]

# calculate losses values
Bbub_com_cafe_input_data_losses$losses_value <- as.numeric(abs(Bbub_com_cafe_input_data_losses$Bbub - Bbub_com_cafe_input_data_losses$cattle_ave)/Bbub_com_cafe_input_data_losses$cattle_ave)

# filter by losses_value > 0.1 and at least 2 differences
Bbub_com_cafe_input_data_losses[abs(Bbub_com_cafe_input_data_losses$Bbub - Bbub_com_cafe_input_data_losses$cattle_ave) > 2,]%>%arrange(desc(losses_value))%>%filter(losses_value > 0.1)

Bbub_com_cafe_input_data_losses[abs(Bbub_com_cafe_input_data_losses$Bbub - Bbub_com_cafe_input_data_losses$cattle_ave) > 2,]%>%arrange(desc(losses_value))%>%filter(losses_value > 0.1)%>%write_csv("Output/CAFE/counts_sig_losses_buffalo_branch.csv")
```

#### gains

```{r}
Bbub_com_cafe_input_data_gains <- Bbub_com_cafe_input_data[(Bbub_com_cafe_input_data$Bbub > Bbub_com_cafe_input_data$cattle_ave),]

# calculate gains values
Bbub_com_cafe_input_data_gains$gains_value <- as.numeric(abs(Bbub_com_cafe_input_data_gains$Bbub - Bbub_com_cafe_input_data_gains$cattle_ave)/Bbub_com_cafe_input_data_gains$cattle_ave)

# filter by losses_value > 0.1 and at least 2 differences
Bbub_com_cafe_input_data_gains[abs(Bbub_com_cafe_input_data_gains$Bbub - Bbub_com_cafe_input_data_gains$cattle_ave) > 2,]%>%arrange(desc(gains_value))%>%filter(gains_value > 0.1)

Bbub_com_cafe_input_data_gains[abs(Bbub_com_cafe_input_data_gains$Bbub - Bbub_com_cafe_input_data_gains$cattle_ave) > 2,]%>%arrange(desc(gains_value))%>%filter(gains_value > 0.1)%>%write_csv("Output/CAFE/counts_sig_gains_buffalo_branch.csv")
```
